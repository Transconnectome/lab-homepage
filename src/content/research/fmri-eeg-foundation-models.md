...
order: 2
keyHighlights:
  - "[NeuroMamba](https://jubilant-choi.notion.site/neuromamba-neurips2025): First State-Space Foundation Model for 4D functional MRI (NeurIPS 2025 Spotlight)"
  - "[DIVER-0](https://arxiv.org/abs/2507.14141): Fully Channel-Equivariant EEG Foundation Model (ICML 2025 GenBio Spotlight)"
...
### 3. [Spatiotemporal Multi-Band Dynamics](https://doi.org/10.48550/arXiv.2503.23394)
