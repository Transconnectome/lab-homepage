...
export const ui = {
  en: {
    ...
    'home.mapTitle': 'Six networks, one lab',
    'home.mapDesc': 'An illustrative sketch of the brain networks we study — each node links to real lab projects.',
    ...
    'home.researchDesc': 'Five directions, one question: how do neural connections become a mind?',
  ...
  ko: {
    ...
    'home.heroDesc':
      '우리는 뇌의 연결이 어떻게 마음 — 인지, 정서, 발달, 그리고 정신건강의 회복탄력성 — 을 만들어내는지 연구합니다. 뇌 파운데이션 모델, 멀티모달 유전체학, 양자 머신러닝이 우리의 도구이며, ‘잘 보는 것’이야말로 과학적 능력이라 믿습니다.',
    'home.exploreCta': '연구 살펴보기',
    'home.peopleCta': '구성원 만나기',
    'home.mapEyebrow': '연구 지도',
    'home.mapTitle': '여섯 개의 네트워크, 하나의 연구실',
    'home.mapDesc': '연구실이 탐구하는 뇌 네트워크의 일러스트 스케치 — 각 노드는 실제 연구 프로젝트로 연결됩니다.',
    'home.newsEyebrow': '연구실 소식',
    'home.newsTitle': '최근 소식',
    'home.allNews': '전체 소식 →',
    'home.researchEyebrow': '연구',
    'home.researchTitle': '파운데이션 모델부터 예술 전시까지',
    'home.researchDesc': '다섯 갈래의 방향, 하나의 질문: 신경 연결은 어떻게 마음이 되는가?',
    ...
    'research.desc':
      '표현 학습, 집단 유전학, 고성능 컴퓨팅 — 그리고 때로는 미술관까지 — 을 결합해 인간 커넥톰의 기능적 해부학을 연구합니다.',
    ...
    'people.desc':
      '심리학자, 엔지니어, 물리학자, 경제학도, 그리고 미술사학도까지 — 좋은 과학에는 여러 개의 시선이 필요하다고 믿는 서울대학교의 연구팀입니다.',
